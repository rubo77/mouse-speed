#!/usr/bin/python
# bugreport: https://bugs.launchpad.net/ubuntu/+source/workrave/+bug/1089862
# workrave issue: http://sourceforge.net/p/workrave/mailman/message/33095329/
# github: https://github.com/rubo77/mouse-speed
